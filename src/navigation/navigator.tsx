...
import { CarFormScreen, CarListScreen, VehicleFormScreen, VehicleTypeScreen, SplashScreen } from '@screens';
...
export const AppStack = () => {
    ...
    return (
        ...
        >
            ...
            <HomeStack.Screen name="CarListScreen" component={CarListScreen} />
        </HomeStack.Navigator>
    );
};
